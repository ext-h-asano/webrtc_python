...
const serverConfig = {
        ...
        key: fs.readFileSync('/etc/letsencrypt/live/handling.android-vpn.com/privkey.pem'),
        cert: fs.readFileSync('/etc/letsencrypt/live/handling.android-vpn.com/fullchain.pem')
};
...
const socketProc = function(ws, req) {
        ...
        ws.on('message', function(message) {
                ...
                if (json.type) {
                    ...
                    connections.forEach(data => { // このブロック内でdataが定義される
